  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-apple-bg)] font-[system-ui]">
      <div className="w-full max-w-md p-8 bg-[var(--color-apple-glass)] backdrop-blur-xl border border-[var(--color-apple-border)] rounded-3xl shadow-2xl">
        ...
        <h2 className="text-3xl font-bold text-center text-[var(--color-apple-text)] mb-2 tracking-tight">Create Account</h2>
        <p className="text-center text-[var(--color-apple-text-muted)] mb-8">Join DevGrasp</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-[var(--color-apple-text-muted)] mb-1 ml-1">Name</label>
            <input 
              type="text" 
              required
